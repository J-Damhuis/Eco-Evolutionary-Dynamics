...
makeplots <- function(filename, heatmap, stepsize = 0.05, everyntimesteps = 1) {
  ...
  png("plots.png") #Create png file named plots
  print(plot1) #Print plot1 onto plots.png; for some reason it changes to all three plots at the end of the function, which is fine with me
  
  png("fraction.png") #Create png file named fraction
  ...
  png("heatmap.png") #Create png file named heatmap
